...
import com.oxyexpress.restaurants.SlidingImage_Adapter;
...
import com.oxyexpress.restaurants.adapter.ExpandableListItemAdapter;
...
import com.oxyexpress.view.parallaxscroll.YPYExpandableListView;
...
public class FragmentHome extends Fragment implements IMyRestaurantConstants {
	...
	private static ViewPager mview;
	...
	private static final Integer[] IMAGES= {R.drawable.a,R.drawable.b,R.drawable.c,R.drawable.d,R.drawable.e};
	...
	private void findView() {
		...
		mview = (ViewPager)mRootView.findViewById(R.id.img);
		this.txtview1 = (TextView)mRootView.findViewById(R.id.textView8);


		Typeface mTypefaceSignika = Typeface.createFromAsset(getContext().getAssets(), "fonts/Signika-Light.otf");
		this.txtview1.setTypeface(mTypefaceSignika);
	...
	private void init() {
		...
		mPager = (ViewPager) mRootView.findViewById(R.id.img);
	...
	public boolean checkBack(){
		if(mExListItemDish.getVisibility()!=View.GONE){
