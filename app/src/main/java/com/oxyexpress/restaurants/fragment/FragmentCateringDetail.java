...
public class FragmentCateringDetail extends DBFragment implements IMyRestaurantConstants {

	public static final String TAG = FragmentCateringDetail.class.getSimpleName();
