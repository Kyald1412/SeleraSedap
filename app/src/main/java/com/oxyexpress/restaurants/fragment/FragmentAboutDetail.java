...
public class FragmentAboutDetail extends DBFragment implements IMyRestaurantConstants {

	public static final String TAG = FragmentAboutDetail.class.getSimpleName();
	...
	public View onInflateLayout(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fragment_detail_catering, container, false);
	}
	...
	public void findView() {
		...
		this.mTvTitle.setTypeface(mTypefaceSignika);
